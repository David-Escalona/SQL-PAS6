...
class User {
        ...
        public function Save() {
                if (isset($this->ID)) {
                        ...
                        $objStatement->execute();
                        logMessage("SE HA ACTUALIZADO" .$ID ."\n", 100);
                } else {
                        $strValueList = "";
                       ...
                       logMessage("SE HA INSERTADO" .$ID ."\n", 25);
                }
        }

        public function MarkForDeletion() {
                $this->blForDeletion = true;
                logMessage("SE HA MARCADO PARA BORRAR\n", 25);
        }
        ...
        private function SetAccessor($strMember, $strNewValue) {
                ...
                if (property_exists($this, $strMember)) {
                        ...
                        logMessage("S'ha cridat la funció SetAccessor\n", 50);
                } else {
                        return(false);
                };
        }
        ...
        private function GetAccessor($strMember) {
                if (property_exists($this, $strMember)) {
                        ...
                        return($strRetVal);
                        logMessage("S'ha cridat la funció GetAccessor amb \n", 50);
                } else {
                        return(false);
                };
        }
